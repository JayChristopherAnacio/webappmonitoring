            ...
            <div class="row">
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <table id="accounts_tbl" class="table table-bordered">
                            <thead>
                                <tr>
									<th>ID</th>
                                    <th>First Name</th>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form id = "AccountForm" class="form-vertical" role="form">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary" id="AddProcess_btn" data-bind="click: AddAccount">Submit</button>
                </div>
            </div>
...
<button id ='debuger' type="button" class="btn btn-default" >Close</button>
	...
	<script src="js/Accounts - viewModel.js"></script>
    ...
    <script>
		$(document).ready(function() {
			...
			//MVVM JS KO========================================================================
			window.viewModel = new window.AccountsVm();
			ko.applyBindings(window.viewModel);
			
			
			$("#debuger").click( function(){
				table.ajax.reload();
			});
        });
    </script>
