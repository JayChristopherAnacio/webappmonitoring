        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary" id="AddProcess_btn" data-bind="click: AddBtn">Submit</button>
                </div>
            </div>
...
<button id ='debuger' type="button" class="btn btn-default" >Close</button>
	...
	<script src="js/Role - viewModel.js"></script>
